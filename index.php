...
match ($page) {
    ...
    'project-file-preview-pdf' => (new ProjectsController())->filePreviewPdf(),
    'project-file-version-preview' => (new ProjectsController())->fileVersionPreview(),
    'project-file-version-preview-pdf' => (new ProjectsController())->fileVersionPreviewPdf(),
    ...
    'project-zip-entry-preview-pdf' => (new ProjectsController())->zipEntryPreviewPdf(),
    ...
    'project-draft-upload' => (new ProjectsController())->uploadProjectDraftFile(),
    ...
    'repository-teacher-project-detail' => (new RepositoryController())->teacherOwnedProjectDetail(),
    ...
    'repository-direct-project-save' => (new RepositoryController())->saveDirectProject(),
    'repository-direct-project-status' => (new RepositoryController())->changeDirectProjectStatus(),
    'repository-direct-project-trash' => (new RepositoryController())->trashDirectProject(),
    'repository-direct-project-restore' => (new RepositoryController())->restoreDirectProject(),
    'repository-teacher-trash' => (new RepositoryController())->manageTeacherTrash(),
    'repository-direct-project-file' => (new ProjectDocumentController())->change(),
    ...
    'support-material-teacher-detail' => (new SupportMaterialController())->teacherOwnedDetail(),
    ...
    'support-material-manage-status' => (new SupportMaterialController())->manageOwnedStatus(),
