...
VALUES
('PAGE-DEMO-001',@project_type_id,@career_id,@period_id,'Sistema de reservas para laboratorios','Prueba de paginación 1','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion01@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-002',@project_type_id,@career_id,@period_id,'Aplicación de control de asistencia','Prueba de paginación 2','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion02@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-003',@project_type_id,@career_id,@period_id,'Portal de seguimiento de tutorías','Prueba de paginación 3','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion03@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-004',@project_type_id,@career_id,@period_id,'Gestor documental para secretaría','Prueba de paginación 4','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion04@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-005',@project_type_id,@career_id,@period_id,'Panel de indicadores estudiantiles','Prueba de paginación 5','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion05@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-006',@project_type_id,@career_id,@period_id,'Plataforma de encuestas académicas','Prueba de paginación 6','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion06@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-007',@project_type_id,@career_id,@period_id,'Sistema de préstamos tecnológicos','Prueba de paginación 7','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion01@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-008',@project_type_id,@career_id,@period_id,'Agenda institucional inteligente','Prueba de paginación 8','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion02@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-009',@project_type_id,@career_id,@period_id,'Repositorio de recursos didácticos','Prueba de paginación 9','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion03@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
('PAGE-DEMO-010',@project_type_id,@career_id,@period_id,'Monitoreo de infraestructura de red','Prueba de paginación 10','Proyecto demostrativo para validar listados extensos.','group',@teacher_id,@teacher_id,'published','published',(SELECT id FROM users WHERE email='paginacion04@demo.local'),CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)
