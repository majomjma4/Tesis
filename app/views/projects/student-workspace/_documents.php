...
?>
    ...
    <section class="sw-viewer-panel">
        <div class="sw-project-actions">
            ...
            <div class="sw-project-actions-file">
                <button type="button" class="sw-viewer-action is-file-download" data-sw-viewer-download aria-label="Descargar documento original" disabled><i class="fa-solid fa-download" aria-hidden="true"></i> Descargar original</button>
    ...
    <div class="sw-operation-modal" data-sw-download-confirm-modal hidden><section role="dialog" aria-modal="true" aria-labelledby="swDownloadConfirmTitle" aria-describedby="swDownloadConfirmMessage" tabindex="-1"><header><h2 id="swDownloadConfirmTitle" data-sw-download-title>Descargar documento original</h2><button type="button" data-sw-download-cancel aria-label="Cerrar"><i class="fa-solid fa-xmark" aria-hidden="true"></i></button></header><div><p id="swDownloadConfirmMessage" data-sw-download-message>Las observaciones y correcciones de la revisión no se incorporan al archivo descargado. Se descargará el documento original que fue enviado.</p></div><footer><button type="button" data-sw-download-cancel>Cancelar</button><button type="button" class="is-primary" data-sw-download-confirm>Descargar original</button></footer></section></div>
