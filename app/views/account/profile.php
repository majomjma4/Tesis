...
<main class="profile-shell">
    ...
    <header class="profile-header"><span><?= e(mb_strtoupper(mb_substr($profile['full_name'],0,1,'UTF-8'),'UTF-8')) ?></span><div><small>Cuenta institucional</small><h1><?= e($profile['full_name']) ?></h1><p><?= e($profile['email']) ?></p></div></header>
    <div class="profile-grid">
        <section>
            ...
            <form id="profileForm" method="post" data-profile-form>
                ...
                <button type="submit" data-profile-submit>Guardar cambios</button>
            </form>
        </section>
        <aside><h2>Resumen de la cuenta</h2><dl>
            <div><dt>Cédula</dt><dd><?= e($profile['institutional_code'] ?: 'No registrada') ?></dd></div>
        ...
        </dl><a href="<?= e(route('change-password')) ?>"><i class="fa-solid fa-key"></i> Cambiar contraseña</a></aside>
    </div>
</main>
