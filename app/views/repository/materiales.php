...
<?php if (!empty($canCreateSupportMaterial)): ?>
<style>
#supportMaterialsPage~.ed-edit-modal{position:fixed;z-index:2100;inset:0;background:rgba(15,23,42,.62);display:grid;place-items:center;padding:12px}#supportMaterialsPage~.ed-edit-modal[hidden]{display:none}#supportMaterialsPage~.ed-edit-modal-card{width:min(620px,100%);max-height:calc(100dvh - 24px);overflow:auto;border:1px solid var(--line);border-radius:18px;background:var(--surface);box-shadow:0 30px 80px rgba(15,23,42,.34)}#supportMaterialsPage~.ed-edit-modal-header{padding:18px 20px;border-bottom:1px solid var(--line);display:flex;justify-content:space-between;gap:14px}#supportMaterialsPage~.ed-edit-modal-heading h2{margin:0}#supportMaterialsPage~.ed-edit-modal-heading p{margin:5px 0 0;color:var(--muted);font-size:var(--font-sm)}#supportMaterialsPage~.ed-edit-modal-body{display:grid;gap:12px;padding:20px}#supportMaterialsPage~.ed-edit-modal-body label{display:grid;gap:6px;color:var(--text);font-size:var(--font-sm);font-weight:700}#supportMaterialsPage~.ed-edit-modal-body input,#supportMaterialsPage~.ed-edit-modal-body select,#supportMaterialsPage~.ed-edit-modal-body textarea{width:100%;box-sizing:border-box;padding:10px;border:1px solid var(--line);border-radius:9px;background:var(--surface);color:var(--text);font:inherit}#supportMaterialsPage~.ed-edit-modal-body textarea{min-height:78px;resize:vertical}#supportMaterialsPage~.ed-form-actions{display:flex;justify-content:flex-end;gap:8px}#supportMaterialsPage~[data-teacher-material-error]{color:#b42318;font-size:var(--font-sm)}@media(max-width:480px){#supportMaterialsPage~.ed-edit-modal{padding:6px}#supportMaterialsPage~.ed-edit-modal-header,#supportMaterialsPage~.ed-edit-modal-body{padding:14px}#supportMaterialsPage~.ed-form-actions{display:grid;grid-template-columns:1fr 1fr}}
</style>
