...
.ed-evolution-head p{font-size:var(--font-md);line-height:1.6}.ed-evolution-group-copy strong{font-size:var(--font-lg);line-height:1.4}.ed-evolution-group-meta{font-size:var(--font-sm);line-height:1.5}.ed-evolution-status{font-size:var(--font-xs)}.ed-evolution-unavailable{font-size:var(--font-sm);line-height:1.5}.ed-version-number{font-size:var(--font-sm)}.ed-version-main strong{font-size:var(--font-md);line-height:1.4}.ed-version-meta{font-size:var(--font-sm);line-height:1.5}.ed-version-badge{font-size:var(--font-xs)}.ed-version-actions a,.ed-version-actions button{font-size:var(--font-sm)}.ed-version-missing{font-size:var(--font-sm);line-height:1.55}
...
<div class="ed-academic-history" data-project-histories>
    ...
    <section id="academicHistorySection" aria-labelledby="academicHistoryTitle">
        <header class="ed-academic-head"><div><h2 id="academicHistoryTitle">Historial académico</h2><p><?= (string)($digitalRecord['context']??'')==='academic_management'?'Recorrido institucional del proyecto desde su registro.':'Recorrido institucional del proyecto desde su registro hasta la publicación.' ?></p></div><div class="ed-academic-head-actions"><span class="ed-academic-count"><?=$academicTotal?> eventos</span><?php if($modificationEntries):?><button type="button" data-history-toggle aria-expanded="true" aria-controls="academicHistoryBody" aria-label="Plegar Historial académico"><i class="fa-solid fa-chevron-up" aria-hidden="true"></i></button><?php endif;?></div></header>
        <div id="academicHistoryBody" data-history-collapsible>
        <?php if(!$academicEntries):?><p class="ed-project-history-empty">Aún no existen eventos registrados para este proyecto.</p><?php else:?>
