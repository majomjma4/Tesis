                ...
                <div class="ed-actions" aria-label="Acciones del expediente">
                    ...
                    <?php if ($menuActions): ?><div class="ed-menu" data-record-menu>
                        ...
                        <div class="ed-menu-panel" role="menu" hidden data-record-menu-panel>
                            <?php foreach ($menuActions as $item): ?><button type="button" role="menuitem"<?= empty($item['enabled']) ? ' disabled' : '' ?> class="<?= !empty($item['danger']) ? 'is-danger' : '' ?>"><i class="fa-solid <?= e($item['icon']) ?>" aria-hidden="true"></i><?= e($item['label']) ?></button><?php endforeach; ?>
                        </div>
                    </div><?php endif; ?>
                </div>
            </div>
