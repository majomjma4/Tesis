...
.ed-breadcrumb{font-size:var(--font-sm)}.ed-breadcrumb i{font-size:9px}.ed-label{font-size:var(--font-xs)}.ed-meta dt{font-size:var(--font-xs);line-height:1.35}.ed-meta dd{font-size:var(--font-md);line-height:1.45}.ed-action,.ed-menu-panel button{font-size:var(--font-sm);line-height:1.4}.ed-tab{font-size:var(--font-md)}.ed-edit-modal-heading p{font-size:var(--font-sm);line-height:1.45}
...
@media(max-width:480px){.ed-tab{font-size:var(--font-xs)}}
            ...
            <div class="ed-header-top">
                ...
                <div class="ed-actions" aria-label="Acciones del expediente">
                    ...
                    <?php foreach ($actions as $action): $enabled = !empty($action['enabled']); $iconStyle = (string) ($action['icon_style'] ?? 'fa-regular'); $isDownload = !empty($action['download']); ?>
                        ...
                        <?php else: ?><button class="ed-action<?= ($action['kind'] ?? '') === 'primary' ? ' is-primary' : '' ?>" type="button" disabled title="<?= e((string) ($action['title'] ?? 'Disponible en una fase posterior')) ?>"><i class="<?= e($iconStyle) ?> <?= e($action['icon']) ?>" aria-hidden="true"></i><?= e($action['label']) ?></button><?php endif; ?>
                    <?php endforeach; ?>
                    </div>
