...
<section class="admin-metrics" aria-label="Resumen institucional">
    <a href="<?=e(route('projects'))?>" aria-label="Abrir los proyectos activos"><span class="metric-icon projects"><i class="fa-solid fa-folder-open" aria-hidden="true"></i></span><div><small>Proyectos activos</small><strong><?= (int)$dashboard['projects']['active']?></strong><p>Expedientes en flujo académico</p></div><i class="fa-solid fa-arrow-right metric-arrow" aria-hidden="true"></i></a>
    <a href="<?=e(route('projects').'&review_situation=pending')?>" aria-label="Abrir proyectos con observaciones pendientes"><span class="metric-icon observations"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i></span><div><small>Observaciones pendientes</small><strong><?= (int)$dashboard['projects']['pending_observations']?></strong><p>Proyectos que requieren atención del estudiante.</p></div><i class="fa-solid fa-arrow-right metric-arrow" aria-hidden="true"></i></a>
