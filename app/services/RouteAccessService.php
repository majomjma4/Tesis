...
final class RouteAccessService
{
    ...
    private const ADMIN_ROUTES = ['admin-users','admin-user-save','admin-user-status','admin-user-password','admin-users-import','admin-project-save','admin-project-trash','admin-academic','admin-academic-save','admin-academic-promote','admin-repository-publish','admin-notification-send','admin-reports','admin-settings','admin-trash','admin-trash-user','admin-trash-restore','admin-trash-purge'];
