...
final class RouteAccessService
{
    ...
    private function isSupportMaterialFileJsonRequest(string $page): bool
    {
        ...
        return in_array($page,['dismiss-temp-password-warning','profile-avatar-update','profile-avatar-remove','admin-support-material-file','support-material-manage-save','support-material-manage-file','support-material-manage-status','admin-project-file','admin-trash-restore','admin-trash-restore-batch','admin-trash-delete','admin-trash-delete-batch','admin-trash-empty-category','project-document-review-save','project-adjustment-create','project-adjustment-respond','project-adjustment-address','project-adjustment-close','project-adjustment-approve','project-adjustment-reject','project-adjustment-list','thesis-tribunal-suggest','thesis-tribunal-save','thesis-defense-schedule-save','thesis-defense-new-attempt','project-draft-save','project-draft-upload','project-draft-file-remove','project-draft-reset','student-project-review-representation','repository-direct-project-publish','repository-direct-project-save','repository-direct-project-status','repository-direct-project-trash','repository-direct-project-restore','repository-teacher-trash','repository-direct-project-file'],true);
    }
