...
final class RouteAccessService
{
    ...
    private const ADMIN_ROUTES = ['admin-users','admin-user-save','admin-user-status','admin-user-password','admin-users-import','admin-academic','admin-reports','admin-settings','admin-trash'];
