...
SQL;
    ...
    private function copy(string $type,array $p,array $previous,array $new): array
    {
        return match($type){
            ...
            'adjustment_requested'=>['Solicitud administrativa de ajuste',(string)($p['message']??''),'adjustment'],
            ...
            'adjustment_closed'=>['Solicitud administrativa cerrada',(string)($p['message']??''),'adjustment'],
