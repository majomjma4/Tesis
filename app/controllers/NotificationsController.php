...
final class NotificationsController
{
    ...
    private function statusFilters(bool $isAdmin = false): array
    {
        $filters = ['all' => 'Todas', 'unread' => 'No leidas', 'read' => 'Leidas', 'hidden' => 'Archivadas'];
        if ($isAdmin) {
            $filters['sent'] = 'Enviadas';
        }
        $filters['trash'] = 'Papelera';
        return $filters;
    }
